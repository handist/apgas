...
/**
 * The {@link MPILauncherNoExit} class implements a launcher for the apgas runtime
 ...
 * @author Toshiyuki
 */
final public class MPILauncherNoExit implements Launcher {
  ...
  /**
   * Constructs a new {@link MPILauncherNoExit} instance.
   */
  public MPILauncherNoExit() {
  }
   ...
   * <p>
   * Current implementation of {@link MPILauncherNoExit} always returns true.
   *
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (commRank == 0) {
      try {
        ...
        // Prevent call to exit() with a security manager
